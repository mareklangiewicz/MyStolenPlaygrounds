...
fun Playgrounds() {
    ...
    val samples = listOf(
        ...
        MySampleData("androidx.compose.ui.samples.KeyEventSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.KeyEventSample() },
        MySampleData("androidx.compose.ui.samples.KeyEventTypeSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.KeyEventTypeSample() },
        MySampleData("androidx.compose.ui.samples.KeyEventIsAltPressedSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.KeyEventIsAltPressedSample() },
        MySampleData("androidx.compose.ui.samples.KeyEventIsCtrlPressedSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.KeyEventIsCtrlPressedSample() },
        MySampleData("androidx.compose.ui.samples.KeyEventIsMetaPressedSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.KeyEventIsMetaPressedSample() },
        MySampleData("androidx.compose.ui.samples.KeyEventIsShiftPressedSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.KeyEventIsShiftPressedSample() },
        MySampleData("androidx.compose.ui.samples.RotaryEventSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.RotaryEventSample() },
        MySampleData("androidx.compose.ui.samples.PreRotaryEventSample", "${samplesDir}/stolen/ui-samples/FocusAwareInputSamples.kt") { androidx.compose.ui.samples.PreRotaryEventSample() },
